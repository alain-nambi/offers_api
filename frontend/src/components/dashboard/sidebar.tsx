  ...
  return (
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col h-full">
      ...
      <ScrollArea className="h-100 w-100%">
        <div className="flex-1 p-4 space-y-6">
          <nav className="space-y-1">
            ...
            <Button variant="ghost" className="cursor-pointer w-full justify-start px-3 py-2 text-gray-800 bg-gray-100">
              <BarChart3 className="w-5 h-5 mr-3" />
              Dashboard
            </Button>
            <Button variant="ghost" className="cursor-pointer w-full justify-start px-3 py-2">
      ...
      <div className="p-4 border-t space-y-2">
        ...
        <Button variant="ghost" className="w-full justify-start px-3 py-2 hover:bg-red-50 hover:text-red-600">
